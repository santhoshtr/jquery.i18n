var BananaDefaultLanguage = {
	language: 'default',
	pluralRuleParser: null,
	...
	convertPlural: function ( count, forms ) {
		...
		pluralRules = this.pluralRules[ this.language ];
	...
	getPluralForm: function ( number, pluralRules ) {
		var i,
			...
			pluralRuleParser = pluralRuleParser || this.pluralRuleParser,
			pluralFormIndex = 0;

		for ( i = 0; i < pluralForms.length; i++ ) {
			if ( pluralRules[ pluralForms[ i ] ] && pluralRuleParser ) {
				if ( this.pluralRuleParser( pluralRules[ pluralForms[ i ] ], number ) ) {
	...
	convertNumber: function ( num, integer ) {
		...
		transformTable = this.digitTransformTable( this.language );
...
( function ( root, factory ) {
	if ( typeof define === 'function' && define.amd ) {
		...
		root.BananaLanguages.default = factory;
	}
}( this, BananaDefaultLanguage ) );
